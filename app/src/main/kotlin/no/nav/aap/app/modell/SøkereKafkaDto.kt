...
data class SøkereKafkaDto(
    ...
    data class Sykepengedager(
        val sykepengedagersid: UUID,
        val innvilget: Boolean,
        val inntektsgrunnlag: Inntektsgrunnlag,
        val sykepengedagersdato: LocalDate,
...
fun DtoSøker.toJson() = SøkereKafkaDto(
    ...
    saker = saker.map { sak ->
        SøkereKafkaDto.Sak(
            ...
            sykepengedager = sak.sykepengedager?.let { sykepengedager ->
                SøkereKafkaDto.Sykepengedager(
                    sykepengedagersid = sykepengedager.sykepengedagersid,
                    innvilget = sykepengedager.innvilget,
                    inntektsgrunnlag = sykepengedager.inntektsgrunnlag.let { inntektsgrunnlag ->
                    ...
                    sykepengedagersdato = sykepengedager.sykepengedagersdato,
                    virkningsdato = sykepengedager.virkningsdato,
                )
            }
        )
    },
