...
private fun Sak.toDto() = SøkereKafkaDto.Sak(
    ...
    sykepengedager = sykepengedager?.toDto()
)
...
private fun Sykepengedager.toDto() = SøkereKafkaDto.Sykepengedager(
    sykepengedagersid = sykepengedagersid,
    innvilget = innvilget,
    inntektsgrunnlag = inntektsgrunnlag.toDto(),
    sykepengedagersdato = sykepengedagersdato,
